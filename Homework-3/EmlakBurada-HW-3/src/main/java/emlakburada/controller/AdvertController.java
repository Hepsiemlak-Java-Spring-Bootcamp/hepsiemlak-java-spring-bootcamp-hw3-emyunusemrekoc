...
public class AdvertController {
	...
	@GetMapping(value = "/favorite-adverts/{userId}")
	public ResponseEntity<List<AdvertResponse>> findFavoriteAdvertsByUserId(@PathVariable(required = false) int userId) {
		return new ResponseEntity<>(advertService.findFavoriteAdvertsByUserId(userId), HttpStatus.OK);
	}
}
